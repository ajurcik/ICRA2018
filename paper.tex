\documentclass[usletter, 10pt, conference]{ieeeconf}      % for icra
...
\begin{abstract}
Chemical interactions of proteins and other molecules takes place in actives sites that are usually deeply burid inside the proteins.
...
This can be solved using motion planning, where the ligand is considered as a robot moving amongst protein's atoms.
