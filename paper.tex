...
Our approach aims to overcome this problem by taking into account the actual shape of the ligand and additionally also its evolution over time, i.e. its flexibility.}
...
$\da(q_1,q_2)$.
This metric is sensitive to the shape of the ligand (that is given by it's conformation) as it computes the distance using the two nearest atoms of the two configurations.
...
Based on the number of success rate, also other ligands (e.g., m037t with traversability rate 45~\% at $\smin$=0.8) seem to be promissing.
