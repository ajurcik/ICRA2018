...
On the other hand, there is not practical difference between \RA\ and \RC\ in the case of more scaled-down ligands.
...
the planner prefers to apply the large scales in possible.
...
Our proposed visualization allows the biochemists to observe those parts of the tunnel where the ligand had to be scaled-down significantly (red parts of trajectories in Fig.~\ref{fig::dcp}), and parts where the ligand could be enlarged again (green parts in Fig.~\ref{fig::dcp}).
