...
The ordering of the tunnels can slightly change due to conformational changes, so the traversability
to the active site was computed for the first three tunnels (with average bottlenecks 1.22~\AA, 1.20~\AA and 1.19~\AA).
Due to size of the ligand (which has 33 atoms) and the low bottlenecks of the tunnels, we 
...
\begin{figure}
\centering
\caption{\label{fig::inhibitor}Example of inhibitor in 4L2L ... }
\end{figure}
