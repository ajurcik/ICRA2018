...
This requires the analysis of contact space, which leads to the generalized penetration depth computation of high complecity~\cite{zhang2008fast,he2016efficient}. %\cite{he2016efficient} in RAL!!
...
First, the maximal scale $\smax \in \S$ is selectd and $m$ random samples are generated around $\qrand$ and tested for collisions.
