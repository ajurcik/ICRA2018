...
\textcolor{blue}{i.e., they approximate the ligand by a bounding sphere.}
...
Such a ligand, changing the mutual position of its atoms, is denoted as a flexible ligand.
...
and translation) and it employs the other DOFs (i.e., those that are responsible for \textcolor{blue}{conformation/al?} changes) if they hinder the growth of the tree.
...
Each candidate conformation is ranked according its energy and only low-energy conformation are used in $\L$.
...
to the selection of packed conformations (examples are shown in Tab.~\ref{fig::m040c}).
