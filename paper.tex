...
Low deviation is characteristic for `packed' conformations, while larger deviations correspond to the elongated conformations (Tab.~\ref{fig::m040c}).
...
The ordering of the detected tunnels slightly differ in different conformations.
