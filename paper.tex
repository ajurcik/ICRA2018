...
More details can be found in the recently published state-of-the-art report about the analysis and visualization of biomolecular cavities~\cite{Krone_2016}.
...
The approach~\cite{singhLIG} can be also used to predict the ligand binding sites.
...
This parameter should be set considering the existence of cavities or other tunnels around the tunnel being investigated.
