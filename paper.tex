...
PRM-based techniques solve the problem by increasing probablity of sampling in regions close to obstacles~\cite{hsuBridge,overmarsGauss}.
These regions can be estimated e.g. based on amount of collision-free samples around a given sample~\cite{overmarsGauss} or e.g. based
on workspace information represented by medial axis~\cite{amatoOBRRT,amato2002using}.
...
This is the main idea of the guided sampling~\cite{vonasek2009rrt,denny2014marrt,denny2016dynamic}.
