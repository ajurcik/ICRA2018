...
Instead, the random samples has to be generated in the difficult regions only if the tree can approach them.
...
Four different scaling-down factors were used: $\smin=\{0.4,0.5,0.6,0.7\}$.
