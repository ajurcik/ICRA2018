...
Sampling-based motion planning can be used to analyze the traversability of the tunnels for non-spherical and flexible ligands.
Motion planning inside protein structures leads to the narrow passage problem while considering flexible ligands increasing
the degrees of freedom, and consequently the dimension of the configuration space.
...
In this paper, we propose a modification to the Rapidly Exploring Random Tree planner.
...
The radius of a ball is default infinity, but if the node cannot be expanded, it is set to a predefined (small) value.
