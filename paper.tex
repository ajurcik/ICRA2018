...
The number of generated ligand conformations $|\L|$ depends on the number of rotatable bonds of the ligands.
Although only the low-energy conformations are generated and saved to $\L$, the number of all conformations can still be large for
ligands with many rotatable bonds.
The aim of this experiment was to verify the procedure to select a subset of ligand conformations from $\L$.
...
The next studied case was the analysis of Leukotriene A4 hydrolase (PDB ID 4L2L).
The task was to find trajectory for the ligand 4-(4-benzylphenyl)-1,3-thiazol-2-amine, which is a known inhibitor of the protein 4L2L.
We therefore assume that the ligand can reach the active site.
%which was in the protein crystal structure (PDB ID 4L2L). 
...
The tunnels towards the active site (defined by residues 134 (Alanine) and 311 (Phenylalanine) for probe 0.9~\AA\ were calculated
using CAVER 3.0.
