...
The table shows the average number of conformations (out of 50) used in trajectories reaching the active site in the 4E46 protein.
}
\centering
{\footnotesize
...
%\cite{hess2008gromacs} 
 using the input parameters recommended on the example page tCONCOORD~\cite{tconcoord}.
...
the active site was considered as rached if the distance to the geometric center of the ligand was less than 5~\AA.
All paramters of the \RA\ were set as in the previous experiment, except $\Imax=100\cdot10^3$.
